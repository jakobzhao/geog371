...
| Wk 05 |  [Map Server I: Base Map Design using Mapbox](lectures/lec13)    | [Map Server II: Intro to GeoServer](lectures/lec10), [ :rocket: Quiz 1](quizzes/quiz01/)     |          [Lab 4: Design Basemap](labs/lab04/)  |  [Map Server III: Web Map Services](lectures/lec12), :Rocket: [Quiz 02](quizzes/quiz02)   | [Bing Map Tile, WFS and WMS](readings/wk05.md) |
