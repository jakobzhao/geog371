...
| Wk 08 |  :airplane:  Storytelling with Web Map II, cont'd with the last lecture      |  :airplane:   [Map Design III: User Friendly Design Principles](lectures/lec19)     |              Lab 5: Cont'd               |    :airplane:  [3D Web Mapping I: Basics](lectures/lec23)         |         [Cesium Documentation](readings/wk08.md)                         |
