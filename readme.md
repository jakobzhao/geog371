...
| Wk 03 | *MLK Day* |  [Web Programming Basics IV: Debugging](lectures/lec05) and [debugging](https://scotch.io/tutorials/debugging-javascript-with-chrome-devtools-breakpoints) :bug:|          [Lab 3: Web Map Design](labs/lab03/readme.md)           |[Spatial Data for Web Mapping](lectures/lec06)  |  Cont'd with last week's reanding and [Leaflet and GeoJson](readings/wk03.md)  |
...
| Wk 05 |  [Map Server I: Base Map Design using Mapbox](lectures/lec13)    | [Map Server I: Intro to GeoServer](lectures/lec10), [Quiz 1](quizzes/quiz01/)     |          [Lab 4: Web Map Services and Basemap](labs/lab04/)  | [Map Server II: Styling](lectures/lec11)  [Map Server III: Web Map Services](lectures/lec12)  | [Bing Map Tile, WFS and WMS](readings/wk05.md) |
| Wk 06 |                          |   [Map Server V: Map Tiles](lectures/lec14)   :airplane: |              Lab 4: Cont'd               |   Midterm Exam  | [Bootstrap Documentation](readings/wk06.md) |
