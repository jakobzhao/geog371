...
| Wk 05 |  [Map Server I: Base Map Design using Mapbox](lectures/lec13)    | [Map Server I: Intro to GeoServer](lectures/lec10), [Quiz 1 :rocket:](quizzes/quiz01/)     |          [Lab 4: Web Map Services and Basemap](labs/lab04/)  | [Map Server II: Styling](lectures/lec11)  [Map Server III: Web Map Services](lectures/lec12)  | [Bing Map Tile, WFS and WMS](readings/wk05.md) |
| Wk 06 |                          |   [Map Server V: Map Tiles](lectures/lec14)   :airplane: |              Lab 4: Cont'd               |   Midterm Exam :book:  | [Bootstrap Documentation](readings/wk06.md) |
