...
- for color blindness. (refer to [https://coolors.co/](https://coolors.co/)); and
...
If you design a map representing a LGBT topic or a Valentine's Day :heart: topic, you will receive the addtional points (**5 POINTS**). Think out aloud, what color ramp is appropriate for a LGBT theme? Like :rainbow: a rainbow color flag ?
