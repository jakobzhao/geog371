 ...
 * Load TopoJSON Instead of GeoJSON
 */
...
// Get TopoJSON and put on it on the map when it loads
...
// Get TopoJSON and put on it on the map when it loads
$.getJSON("assets/cell_towers.topojson", function(data){
    // add the cell tower TopoJSON layer to the map
