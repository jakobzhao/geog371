...
// Use the default port of Node, but you can surely change to other ports.
          ...
          stream.on('data', function(data) {
              ...
              if (data.coordinates){
                if (data.coordinates !== null){
                  ...
                  var pntfeature = {"lat": data.coordinates.coordinates[0],"lng": data.coordinates.coordinates[1]};
